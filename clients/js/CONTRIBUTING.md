...
This is a quick guide to help you contribute to the JavaScript client of Fees Program.
...
- `VERCEL_PROJECT_ID` — The ID of the Vercel project you want to deploy to.
  The convention is to create a new Vercel project named `fees-program-js-docs` with the following deployment settings:
